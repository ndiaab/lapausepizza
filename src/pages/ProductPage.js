    ...
    return (
        <>
            <div className='ProductPage container'>
                <h2 className='ProductPage mobile titleProduct '>{`${props.product.type} ${props.product.title}`}</h2>
                <div className='ProductPage illustration'>
                    <img src={props.product.image} style={{ width: "100%" }} alt={props.product.type + "-" + props.product.name} />
                </div>
                <div className='ProductPage presentation'>
                    ...
                    <p>{props.product.type === props.type && props.configData.pizzaDetails}</p>
